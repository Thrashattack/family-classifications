...
var SignInService = /** @class */ (function () {
    ...
    SignInService.prototype.execute = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            var login, password, user, isPasswordCorrect;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        login = request.login, password = request.password;
                        return [4 /*yield*/, this.UserRepository.findOne(login)];
                    case 1:
                        user = _a.sent();
                        isPasswordCorrect = user.password === this.PasswordProvider.provide(password);
